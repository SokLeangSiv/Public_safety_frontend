    ...
    <div class="flex justify-center items-center">
        <div class="w-full lg:w-[40%] h-1/2 bg-[#f2f1f1] p-8 mt-20 mb-20 shadow-2xl sha rounded-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-1 gap-x-7 mb-8 pe-5">
                ...
                <div>
                    <label for="first-name" class="block text-sm font-semibold leading-6 text-black">Description</label>
                    <div class="mt-2.5">
                        <textarea placeholder="Feedback to improve our service" rows="4" class="textarea textarea-bordered textarea-sm w-full max-w-full rounded-md  text-gray-900 shadow-sm shadow-slate-500 ring-1 ring-inset ring-slate-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400" ></textarea>
                    </div>
                </div>
